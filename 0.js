...
/* harmony default export */ __webpack_exports__["default"] = (function (wasm_wrapper) {
  var imports_lib = {
    console_log: function console_log(size, types_addr, values_addr) {
      ...
      var any_value_size = wasm_wrapper.size_t(wasm_wrapper.globals.__any_value_size)[0];
    ...
    if (self.window) {
      ...
      Object.assign(imports_lib, {
        atomic_lock: function atomic_lock(atomic_addr) {
          ...
          do {
            Atomics.wait(wasm_wrapper.memory_views.I32, __atomic_malloc_index, LOCKED, Infinity);
...
/*!*************************************************************!*\
  ...
  \*************************************************************/
/*! exports provided: PromiseBunch, Thread, Thread2, Thread3, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var Thread = _threads_thread__WEBPACK_IMPORTED_MODULE_2__["default"];
var Thread2 = _threads_thread2__WEBPACK_IMPORTED_MODULE_3__["default"];
var Thread3 = _threads_thread3__WEBPACK_IMPORTED_MODULE_4__["default"];
          ...
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 40:
              if (configureMemory) {
                ...
                DEBUG_LOG(this.mem);
                DEBUG_INFO_PUSH("WASM MEMORY SIZE: ".concat(this.memory.buffer.byteLength));
                DEBUG_LABEL_LOG();
              }
              if (this.exports.__main) {
                this.__thread_id = this.exports.__main(stack_pointer);
                DEBUG_INFO_PUSH("WASM THREAD: ".concat(this.__thread_id));
              }
              if (initGlobals) {
        ...
        return _regeneratorRuntime().wrap(function _callee7$(_context7) {
          while (1) switch (_context7.prev = _context7.next) {
            case 0:
              ...
              _context7.prev = 1;
              _context7.next = 4;
              return __webpack_require__.e(/*! import() */ 5).then(__webpack_require__.bind(null, /*! ./test-simd/build/clang-wasm32/output/wasm/test-simd.wasm */ "../../renderity/wasm-wrapper/src/test-simd/build/clang-wasm32/output/wasm/test-simd.wasm"));
            case 4:
              test_simd_wasm_buffer = _context7.sent["default"];
              _context7.next = 7;
